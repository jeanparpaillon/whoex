defmodule Whoex.Plug do
  @moduledoc """
  The plug specification for DNS.
  ...
  options and returns a connection. Its type signature must be:
      ...
      (Whoex.Conn.t, Whoex.opts) :: Whoex.Conn.t
  ...
  Here's an example of a function plug:
      ...
      def json_header_plug(conn, opts) do
        Whoex.Conn.put_resp_content_type(conn, "application/json")
      end
  ...
  The `Whoex.Builder` module provides conveniences for building plug
  pipelines.
  """
